...
`install.sh` creates or replaces the directory of the version it installs (`0.13.0-beta` in this release), and writes two things outside it: one launch agent, and one marked block in the Codex execpolicy.
